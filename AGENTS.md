...
- 设计固定维度特征，包括 14 条进口车道的占用/速度网格、相位、相位服务年龄、剩余时间、相位压力、交通统计、交通趋势和逐车道统计。
...
- 当前 `Config.DIM_OF_OBSERVATION = 630`，其中 560 维为 14 条进口车道乘 20 个格子的占用和速度，8 维为信号相位与持续时间特征，4 维为相位服务年龄，8 维为相位压力与全局交通统计，8 维为一帧交通趋势，42 维为逐车道统计。
