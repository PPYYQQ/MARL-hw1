...
def main():
    ...
    require("faulthandler.enable" in ppo_agent, "PPO should dump native crash traces when trainer is killed")
    require("PPO_DIAG_PREFIX" in ppo_agent, "PPO should emit startup breadcrumbs for hidden trainer logs")
    require("Agent.__init__ start" in ppo_agent, "PPO should log agent initialization start")
    require("Model parameter_count=" in ppo_agent, "PPO should log registered parameter count")
