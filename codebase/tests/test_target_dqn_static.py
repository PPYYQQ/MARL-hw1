...
def main():
    ...
    require("FRAME_STATE_KEYS" in definition and '"frameState"' in definition, "reward should accept frame_state aliases")
    require("_first_record_value(_obs, FRAME_STATE_KEYS)" in definition, "reward should read frame_state through aliases")
    ...
    require('"vehicleId"' in definition and '"targetJunction"' in definition, "reward should recognize camelCase vehicle dict records")
    require('"positionInLane"' in definition and '"waitingTime"' in definition, "reward should recognize vehicle metric aliases")
    require('"laneId"' in definition and '"vCount"' in definition, "reward should recognize camelCase lane dict records")
    require('"queueLength"' in definition and '"congestionLevel"' in definition, "reward should recognize lane metric aliases")
    ...
    require("LEGAL_ACTION_KEYS" in agent, "agent legal action aliases should be centralized")
    require("PHASE_LEGAL_ACTION_KEYS" in agent, "agent should distinguish explicit phase masks from decision gates")
    require("DECISION_LEGAL_ACTION_KEYS" in agent, "agent should treat generic legal_action as a decision gate")
    require("def _has_positive_action_value" in agent, "agent should detect non-zero decision gates robustly")
    require("def _phase_legal_action" in agent, "agent should derive phase legality from explicit phase masks only")
    require("def _first_mapping_value" in agent, "agent should read scalar or mask field aliases safely")
    require('"legalAction"' in agent and '"phaseLegalAction"' in agent, "agent should accept camelCase legal action aliases")
    require('"actionMask"' in agent and '"phaseMask"' in agent, "agent should accept common legal mask aliases")
    ...
    require("EXTRA_INFO_KEYS" in agent and '"extraInfo"' in agent, "exploit should accept common extra info aliases")
    ...
    require('"vehicleId"' in agent and '"targetJunction"' in agent, "agent should recognize camelCase vehicle dict records")
    require('"positionInLane"' in agent and '"waitingTime"' in agent, "agent should recognize vehicle metric aliases")
    require("vehicle_config_id = vehicle_value" in agent and '"v_config_id"' in agent, "agent should read vehicle config id aliases through shared helper")
    require("vehicle_value(vehicle, \"target_junction\"" in agent, "agent should read target junction aliases through shared helper")
    require('"laneId"' in agent and '"vCount"' in agent, "agent should recognize camelCase lane dict records")
    require('"queueLength"' in agent and '"congestionLevel"' in agent, "agent should recognize lane metric aliases")
    ...
    require("def _phase_record_value" in agent, "phase features should read phase field aliases safely")
    require('"signal_id"' in agent and '"current_phase"' in agent, "phase features should accept signal and current phase aliases")
    require('"signalId"' in agent and '"currentPhase"' in agent, "phase features should accept camelCase signal aliases")
    require('"phase"' in agent and '"phaseId"' in agent, "phase features should accept common phase id aliases")
    require('"remaining_time"' in agent and '"remain_duration"' in agent, "phase features should accept remaining duration aliases")
    require('"remainingTime"' in agent and '"remainTime"' in agent, "phase features should accept camelCase remaining duration aliases")
    ...
    require("FRAME_STATE_KEYS" in agent and '"frameState"' in agent, "observation should accept frame_state aliases")
    require("_first_mapping_value(raw_obs, FRAME_STATE_KEYS" in agent, "observation should read frame_state through aliases")
    require("MAX_SPEED_KEYS" in agent and '"maxSpeed"' in agent, "observation should accept camelCase vehicle config speed")
    ...
    require("def _first_lane_value" in traffic_utils, "lane observation helpers should read field aliases")
    require('"laneId"' in traffic_utils and '"vCount"' in traffic_utils, "lane observations should accept camelCase lane/count aliases")
    require('"queueLength"' in traffic_utils and '"congestionLevel"' in traffic_utils, "lane observations should accept camelCase queue/congestion aliases")
    require('"vehicle_count"' in traffic_utils and '"queue_count"' in traffic_utils, "lane observations should accept alternate metric aliases")
    ...
    require("VEHICLE_FIELD_ALIASES" in traffic_utils, "traffic helpers should centralize vehicle field aliases")
    require('"vehicleId"' in traffic_utils and '"vConfigId"' in traffic_utils, "traffic helpers should accept camelCase vehicle id aliases")
    require('"targetJunction"' in traffic_utils and '"positionInLane"' in traffic_utils, "traffic helpers should accept camelCase vehicle state aliases")
    require('"waitingTime"' in traffic_utils, "traffic helpers should accept camelCase waiting time alias")
    ...
    require('"vehicleId"' in preprocessor and '"targetJunction"' in preprocessor, "traffic preprocessor should recognize camelCase vehicle dict records")
    require('"positionInLane"' in preprocessor and '"waitingTime"' in preprocessor, "traffic preprocessor should recognize vehicle metric aliases")
    require("def _first_record_value" in preprocessor, "road init should read documented field aliases")
    require("_first_record_value(junction" in preprocessor, "road init should normalize string junction ids")
    ...
    require('"junctionId"' in preprocessor and '"edgeId"' in preprocessor, "road init should tolerate camelCase road ids")
    require('"laneConfigs"' in preprocessor and '"vehicleConfigs"' in preprocessor, "road init should tolerate camelCase config containers")
    require('"enterLanesOnDirections"' in preprocessor, "road init should tolerate camelCase lane direction containers")
    require("FRAME_STATE_KEYS" in preprocessor and '"frameState"' in preprocessor, "traffic update should tolerate frame_state aliases")
    require("INIT_STATE_KEYS" in preprocessor and '"initState"' in preprocessor, "traffic update should tolerate init_state aliases")
    require("_first_record_value(raw_obs, *FRAME_STATE_KEYS)" in preprocessor, "traffic update should read frame_state through aliases")
    ...
    require('"totalScore"' in workflow and '"envScore"' in workflow, "workflow should accept camelCase total score aliases")
    require('"avgDelay"' in workflow and '"avgJunctionDelay"' in workflow, "workflow should accept camelCase delay aliases")
    require('"avgQueueLength"' in workflow and '"queueLength"' in workflow, "workflow should accept camelCase queue aliases")
    require('"avgWaitingTime"' in workflow and '"waitingTime"' in workflow, "workflow should accept camelCase waiting aliases")
    require('"switchPenalty"' in workflow and '"signalSwitchCount"' in workflow, "workflow should accept camelCase switch aliases")
    ...
    require("OBSERVATION_KEYS" in workflow and '"observation", "obs", "_obs"' in workflow, "workflow should accept common observation field aliases")
    require("EXTRA_INFO_KEYS" in workflow and '"extraInfo"' in workflow, "workflow should accept common extra info aliases")
    require("FRAME_STATE_KEYS" in workflow and '"frameState"' in workflow, "workflow should recognize camelCase raw observations")
    require("def _need_to_predict" in workflow, "workflow should normalize legal_action before prediction gating")
    require("LEGAL_ACTION_KEYS" in workflow, "workflow legal action aliases should be centralized")
    require('"legalAction"' in workflow and '"phaseLegalAction"' in workflow, "workflow should accept camelCase legal action aliases")
    require('"actionMask"' in workflow and '"phaseMask"' in workflow, "workflow should accept common legal mask aliases")
    ...
    require("def _new_action_stats" in workflow, "workflow action metrics should have a fresh stats helper")
    require("def _default_action_metric_snapshot" in workflow, "workflow action metrics should have default monitor values")
    require("def _update_action_stats" in workflow, "workflow should update action distribution metrics safely")
    require("def _action_metric_snapshot" in workflow, "workflow should convert action stats to monitor data")
    require("_update_action_stats(action_stats, act)" in workflow, "workflow should update action metrics after safe actions")
    require('f"phase_{phase_index}_cnt"' in workflow, "workflow should monitor per-phase action counts")
    require('"avg_duration"' in workflow and '"phase_switch_cnt"' in workflow, "workflow should monitor duration and switches")
    require('"same_phase_ratio"' in workflow, "workflow should monitor repeated phase selections")
    require("phase_switch_rate" in workflow, "workflow should monitor phase switch rate")
    ...
    require('frame_no = _first_env_value(env_obs, ("frame_no", "frameNo"), None)' in workflow, "workflow frame_no should read top-level aliases")
    require('frame_no = _first_env_value(_safe_extra_info(env_obs), ("frame_no", "frameNo"), 0)' in workflow, "workflow frame_no should fall back to extra info aliases")
    require('"frame_no": _safe_frame_no({"extra_info": extra_info})' in workflow, "tuple step frame_no should use safe frame fallback")
    require("frame_no = _safe_frame_no(step_result)" in workflow, "step envelopes should use safe frame fallback")
    ...
    require('"envReward"' in workflow, "workflow should accept camelCase reward aliases")
    require("def _safe_legal_action" in workflow, "workflow should tolerate missing legal_action in sampled frames")
    require("return _first_env_value(obs, LEGAL_ACTION_KEYS, None)" in workflow, "workflow legal_action reads should use centralized aliases")
    require("def _safe_phase_legal_action" in workflow, "workflow should convert platform decision gates to phase masks")
    require("def _decision_gate_open" in workflow, "workflow should separate prediction gating from phase masking")
    require("PHASE_LEGAL_ACTION_KEYS" in workflow, "workflow should recognize explicit phase mask aliases")
    require("DECISION_LEGAL_ACTION_KEYS" in workflow, "workflow should recognize generic decision gate aliases")
    ...
    require("def _normalize_step_record_result" in workflow, "workflow should normalize dict/object step envelopes")
    require("def _looks_like_step_envelope" in workflow, "workflow should recognize step envelope records")
    require('"reward", "score", "env_reward"' in workflow, "workflow should read common step reward aliases")
    require("DONE_FIELD_ALIASES" in workflow, "workflow done field aliases should be centralized")
    require('"terminated"' in workflow and '"done"' in workflow, "workflow should read common step done aliases")
    require('"is_done"' in workflow and '"timeout"' in workflow, "workflow should read common terminal and timeout aliases")
    ...
    require('legal_action=_safe_phase_legal_action(obs)' in workflow, "workflow sampled frame should use phase legality extraction")
