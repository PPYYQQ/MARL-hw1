...
def main():
    ...
    require('"extra_info", "_state", "state", "info"' in agent, "exploit should accept common extra info aliases")
    ...
    require('"extra_info", "_state", "state", "info"' in workflow, "workflow should accept common extra info aliases")
